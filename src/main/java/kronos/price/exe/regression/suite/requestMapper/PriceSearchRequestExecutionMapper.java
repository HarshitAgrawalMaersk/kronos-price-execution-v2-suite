    ...
    public static TreeMap priceSearchRequestToJSON(int rowCount) {
        ...
        try {
            ...
            for(int r=startRow;r<= sh.getLastRowNum();r++) {
                ...
                try {
                     testcase = sh.getRow(r).getCell(RequestColumnConstants.TESTCASE).getStringCellValue().trim();
                    System.out.println("***************EXCEL****************");
                    System.out.println(sh.getRow(r).getCell(RequestColumnConstants.TESTCASE).getStringCellValue().trim());
                    String pcd = sh.getRow(r).getCell(RequestColumnConstants.PCD).getStringCellValue().trim();
                    String brandCode = sh.getRow(r).getCell(RequestColumnConstants.BRAND_CODE).getStringCellValue().trim();
                    String transportActivity = sh.getRow(r).getCell(RequestColumnConstants.TRANSPORT_ACTIVITY).getStringCellValue().trim();
                    String agreementType = sh.getRow(r).getCell(RequestColumnConstants.AGREEMENT_TYPE).getStringCellValue().trim();
                    String agreementlineTypeCodes = sh.getRow(r).getCell(RequestColumnConstants.AGREEMENT_LINE_TYPE_CODES).getStringCellValue().trim();
                    String chargeTypes = sh.getRow(r).getCell(RequestColumnConstants.CHARGE_TYPES).getStringCellValue().trim();
                    String cityCodeDestination = sh.getRow(r).getCell(RequestColumnConstants.CITY_CODE_DESTINATION).getStringCellValue().trim();
                    String countryCodeDestination = sh.getRow(r).getCell(RequestColumnConstants.COUNTRY_CODE_DESTINATION).getStringCellValue().trim();
                    String facilityCodeDestination = sh.getRow(r).getCell(RequestColumnConstants.FACILITY_CODE_DESTINATION).getStringCellValue().trim();
                    String cityCodePOD = sh.getRow(r).getCell(RequestColumnConstants.CITY_CODE_POD).getStringCellValue().trim();
                    String countryCodePOD = sh.getRow(r).getCell(RequestColumnConstants.COUNTRY_CODE_POD).getStringCellValue().trim();
                    String facilityCodePOD = sh.getRow(r).getCell(RequestColumnConstants.FACILITY_CODE_POD).getStringCellValue().trim();
                    String cityCodePODLY = sh.getRow(r).getCell(RequestColumnConstants.CITY_CODE_PODLY).getStringCellValue().trim();
                    String countryCodePODLY = sh.getRow(r).getCell(RequestColumnConstants.COUNTRY_CODE_PODLY).getStringCellValue().trim();
                    String facilityCodePODLY = sh.getRow(r).getCell(RequestColumnConstants.FACILITY_CODE_PODLY).getStringCellValue().trim();
                    String cityCodePOR = sh.getRow(r).getCell(RequestColumnConstants.CITY_CODE_POR).getStringCellValue().trim();
                    String countryCodePOR = sh.getRow(r).getCell(RequestColumnConstants.COUNTRY_CODE_POR).getStringCellValue().trim();
                    String facilityCodePOR = sh.getRow(r).getCell(RequestColumnConstants.FACILITY_CODE_POR).getStringCellValue().trim();
                    String equipmentSizeTypeCode = sh.getRow(r).getCell(RequestColumnConstants.EQUIPMENT_SIZE_TYPE_CODE).getStringCellValue().trim();
                    String commodityCode = sh.getRow(r).getCell(RequestColumnConstants.COMMODITY_CODE).getStringCellValue().trim();
                    String serviceContract = sh.getRow(r).getCell(RequestColumnConstants.SERVICE_CONTRACT).getStringCellValue().trim();
                    String routeCode = sh.getRow(r).getCell(RequestColumnConstants.ROUTE_CODE).getStringCellValue().trim();
                    String finalDestination = sh.getRow(r).getCell(RequestColumnConstants.FINAL_DESTINATION).getStringCellValue().trim();
                    String service = sh.getRow(r).getCell(RequestColumnConstants.SERVICE).getStringCellValue().trim();
                    String option1 = sh.getRow(r).getCell(RequestColumnConstants.OPTION1).getStringCellValue().trim();
                    String shipper = sh.getRow(r).getCell(RequestColumnConstants.SHIPPER).getStringCellValue().trim();
                    String consignee = sh.getRow(r).getCell(RequestColumnConstants.CONSIGNEE).getStringCellValue().trim();
                    String IMO = sh.getRow(r).getCell(RequestColumnConstants.IMO).getStringCellValue().trim();
                    String haulage = sh.getRow(r).getCell(RequestColumnConstants.HAULAGE).getStringCellValue().trim();
                    String cargoType = sh.getRow(r).getCell(RequestColumnConstants.CARGO_TYPE).getStringCellValue().trim();
                    String searchContext = sh.getRow(r).getCell(RequestColumnConstants.SEARCH_CONTEXT).getStringCellValue().trim();
                    String searchConfigurations = sh.getRow(r).getCell(RequestColumnConstants.SEARCH_CONFIGURATIONS).getStringCellValue().trim();
                    String equipmentEventTransportModes = sh.getRow(r).getCell(RequestColumnConstants.EQUIPMENT_EVENT_TRANSPORT_MODES).getStringCellValue().trim();
